...
class FutureWithThread {
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException {
         ...
         * Future<Integer> future = service.submit(task1); // submit callable
         * service.shutdown();
         */
         ...
         * executor.submit(futureTask); // submit futureTask
         * executor.shutdown();
         */
        ...
        // 3. 新建Thread对象并启动
        Thread thread = new Thread(futureTask); // public Thread(Runnable target)
